...
<template>
    <div
        id="feedback-control"
        :class="inline ? '' : 'fixed bottom-4 right-4 z-9999'"
    >
        <UPopover>
            ...
            <template #content="{ close }">
                <div class="p-2">
                    ...
                    <div
                        v-if="!isSubmitted"
                        class="flex flex-col gap-5 w-[360px]"
                    >
                        ...
                        <div class="flex flex-col gap-3">
                            ...
                            >
                                <motion.button
                                    ...
                                    :aria-label="
                                        t(`feedback.ratings.${rating.value}`)
                                    "
                                >
                                    ...
                                    <span
                                        class="text-[0.65rem] whitespace-nowrap text-gray-500 dark:text-gray-400"
                                        >{{
                                            t(
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            />
                            <small
                                class="text-[0.65rem] text-gray-500 dark:text-gray-400 inline-block mt-1"
                        ...
                        <motion.button
                            ...
                            :whilePress="{ scale: isSubmitting ? 1 : 0.98 }"
                            class="w-full"
                        >
                            <UButton
                                :disabled="isSubmitting"
